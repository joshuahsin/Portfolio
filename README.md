...
# Projects
## (In Progress) Flight Booking App (Python Django, JWT Authentication, Redis, Next.js, Cursor AI)
In this project, I created a Flight Booking App, complete with user authentication and authorized endpoints using Django's JWT Authentication. Users will be able to book flights through the App, check in, view the status of their flight, receive notifications on flight updates, and refund flights if they wish. Redis works to cache expensive SQL queries and improve efficiency. React works to save the state of the application where need be and update based on dependency changes. This application was built using the assistance of Cursor AI.

React Frontend: https://github.com/joshuahsin/flight-booking-app-frontend
<br>
Python Django Backend: https://github.com/joshuahsin/FlightBookingBackend

## Weather App (Java Spring Boot, React.js, Node, MySQL, Cursor AI, Gooogle Gemini API, Openweather API, Geoapify API, HTML, CSS)
